          ...
          <div className="container">
            ...
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
              ...
              <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="#1" className="nav-link px-2 text-secondary">Home</a></li>
                <li><a href="#2" className="nav-link px-2 text-white">Sector</a></li>
                <li><a href="#3" className="nav-link px-2 text-white">Pricing</a></li>
                <li><a href="#4" className="nav-link px-2 text-white">FAQs</a></li>
                <li><a href="#5" className="nav-link px-2 text-white">About</a></li>
              </ul>
            ...
            <div className="row">
              ...
              <div className="col-sm-4 offset-md-1 py-4">
                ...
                <ul className="list-unstyled">
                  <li><a href="#1" className="text-white">Follow on Twitter</a></li>
                  <li><a href="#2" className="text-white">Like on Facebook</a></li>
                  <li><a href="#3" className="text-white">Email me</a></li>
                </ul>
              </div>
            </div>
          </div>
